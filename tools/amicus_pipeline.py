...
# ---------------------------------------------------------------- init (scaffold)
SCAFFOLD_KEEP = ["model/lib", "tools", "scripts", ".github", "web/index.html", "web/app.js", "web/style.css", "docs/PIPELINE.md", "docs/AUDITS.md", "tools/clause_ir_schema.json"]
def init(args):
