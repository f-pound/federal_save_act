# Axiom Inventory — Federal SAVE Act ACL2 Model (v6)

All 27 `defaxiom` events classified by label, source, and replacement path.
...
## Text Rules (generated, 1 axiom) + Facts Book (2 axioms)
...
|---|---|---|
| SCENARIO_FACT | 6 | Stipulated test scenario ground facts (shared scenario book) |
